const ngio = new Newgrounds.io.core("49671:tXHPJkBB", "HvZ9KfazyyNDu/QipOKMIw==");
...
function onLoggedIn() {
 ...
 //        }
	// });
	fetchMedals(ngio, console.log);
    fetchScoreBoards(ngio, console.log);
}
...
function unlock(medal) {
     unlockMedal(ngio, medal, medal => console.log(medal.name, 'unlocked'));   
}
